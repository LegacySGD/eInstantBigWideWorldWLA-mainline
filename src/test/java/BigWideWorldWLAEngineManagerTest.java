...
public class BigWideWorldWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(BigWideWorldWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/BigWideWorldWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/BigWideWorldWLAIW/InitOutcome.xml").getDocumentElement();
